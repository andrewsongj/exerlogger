    ...
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            <div class="form-group">
                <label>Name</label>
                <input type="text" name="firstname" class="form-control <?php echo (!empty($name_err)) ? 'is-invalid' : ''; ?>" placeholder="First name">
                <input type="text" name="lastname" class="form-control <?php echo (!empty($name_err)) ? 'is-invalid' : ''; ?>" placeholder="Last name">
            ...
            <div class="form-group">
                ...
                <input type="password" name="password" class="form-control <?php echo (!empty($password_err)) ? 'is-invalid' : ''; ?>" placeholder="At least 6 char.">
